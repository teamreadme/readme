...
function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (userSession.status == "unauthenticated") {
    router.push("/");
    return <></>;
  } else if (userSession.status == "loading") {
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  ...
                  <div className="ml-3">
                    <div className="text-base font-medium leading-none text-white">{userSession.data?.user?.name}</div>
                    <div className="text-sm font-medium leading-none text-gray-400">{userSession.data?.user?.name}</div>
                  </div>
                  <button
                    type="button"
