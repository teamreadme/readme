...
const unauthNavigation = [
    ...
    { name: 'Register', href: '/auth/register', className: '!text-purple-600 hover:!text-purple-700' }
];
...
export default function AppNav(props: AppNavProps) {
    ...
    return <Popover>
        <div className={classNames("relative py-6 mb-4 px-4 sm:px-6 lg:px-8 border-b-[1px] border-gray-200", props.className)}>
        ...
        <Popover.Panel
            focus
            className="absolute z-[200] top-0 inset-x-0 p-2 transition transform origin-top-right lg:hidden"
        >
            <div className="rounded-lg shadow-md bg-gray-100 ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div className="px-5 pt-4 flex items-center justify-between">
                    <div>
                        <LogoWithText
                            extraText={props.logoText}
                            noLogoMargin={true} className="h-8 w-auto"></LogoWithText>
                    </div>
                    <div className="-mr-2">
                        <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500">
